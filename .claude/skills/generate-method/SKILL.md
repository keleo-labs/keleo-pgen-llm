...
3. **Analyze source materials:**
   - Extract structured outcomes (Name, Description, Value Measurement, Related Concerns), concerns, progressive states, work products
...
- Practices should have 1-3 outcomes with measureDescription (@rule:outcome-001)
- Outcome metricContribution.alphaName must match valid alpha (@rule:outcome-002)
- Outcome metricContribution.workProductName, when set, must match a work product; declare metricName on that work product's expectedMetrics
...
### Phase 2 — Outcomes
- **Outcome inflation:** Outcomes are 1-3 per practice, not one per concern. If you have >5 outcomes, you're describing activities or criteria, not value propositions. Each outcome should answer 'what measurable value does adopting this practice deliver?'
